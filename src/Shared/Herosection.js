...
import '../Shared/Herosection.css';


const Herosection = () => {
    return (
<div className='herosectioncontainer my-10'>
<div class="wrapper">
  ...
  <div id="lights"><svg id="lights" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 800 600">
  <defs>
    ...
    <radialGradient id="radial-gradient-2" cx="628.17" cy="270.39" r="41.14" xlinkHref="#radial-gradient"/>
  </defs>
   <g id="light1">
    <g>
